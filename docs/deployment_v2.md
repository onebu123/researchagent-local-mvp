# ResearchAgent v3.0.0-rc1 Deployment Scaffold

This document describes the v2.0 Research Workspace scaffold as maintained in the current `v3.0.0-rc1` repository. It is a local validation and operator planning guide, not a public deployment certificate.
